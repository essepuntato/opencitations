This archive contains the dump of the OpenCitations Corpus (OCC, http://opencitations.net) provenance data about bibliographic resources, created regularly every month.
