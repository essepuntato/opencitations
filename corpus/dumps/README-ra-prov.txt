This archive contains the dump of the OpenCitation Corpus (OCC, http://opencitations.net) provenance data about responsible agents, created regularly every month.
