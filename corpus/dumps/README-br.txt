This archive contains the dump of the OpenCitation Corpus (OCC, http://opencitations.net) dataset about bibliographic resources, created regularly every month.
