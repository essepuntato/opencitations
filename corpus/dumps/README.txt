This archive contains the dump of the OpenCitation Corpus (OCC, http://opencitations.net) [dataset|provenance data] about <name of the dataset>, created regularly every month.
