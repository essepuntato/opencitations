This archive contains the dump of the OpenCitations Corpus (OCC, http://opencitations.net) provenance data about resource embodiments, created regularly every month.
