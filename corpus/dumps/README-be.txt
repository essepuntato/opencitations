This archive contains the dump of the OpenCitation Corpus (OCC, http://opencitations.net) dataset about bibliographic entries, created regularly every month.
