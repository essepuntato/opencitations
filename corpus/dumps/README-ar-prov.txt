This archive contains the dump of the OpenCitations Corpus (OCC, http://opencitations.net) provenance data about author roles, created regularly every month.
