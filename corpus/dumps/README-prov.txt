This archive contains the dump of the OpenCitation Corpus (OCC, http://opencitations.net) provenance data about provenance agents shared by the whole OCC, created regularly every month.
